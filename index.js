...
function fuga(resposta) {
    if (resposta == 2) {
        ...
        let destino = prompt(
            `Boa decisão! A mais segura possível, tendo em vista a situação. Dorsa desenvolveu ${inventario}, itens que agora está armazenado na sua mochila de características.`
        );
